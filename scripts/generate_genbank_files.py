...
with open(sys.argv[1]) as inputfilehandler:
    ...
    for line in inputfilehandler:
        ...
        if line == "":
            ...
            # Create a sequence
            sequence_object = Seq(final_sequence)
            ...
            seq_description = "Unknown description"
            ...
            record.annotations ={"organism": "Cloning Vector", "data_file_division":"SYN", "date":date_today, "molecule_type": "DNA"}
            ...
            if array[5].strip() != "" and array[6].strip() != "":
